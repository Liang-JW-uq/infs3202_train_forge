...
urlpatterns = [
    ...
    path("tag/info/", login_required(tag_view.get_trainer_tags), name="get_trainer_tags"),
    ...
    path('exercises/tags/<str:tag_ids>/', login_required(exercise_view.get_exercises_by_tags), name='exercises_by_tags'),
    ...
    path("client/info/", login_required(client_view.get_client_info), name="get_client_info"),
